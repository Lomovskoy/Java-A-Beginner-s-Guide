/*
	Создайте подкласс Circle, производный от класса TwoDShapes
	в нём должен быть определён метод area(), вычисляющий 
	площадь круга а так же конструктор с ключевым словом super
	для инициализации членов унаследованных от класса TwoDShapes
*/
